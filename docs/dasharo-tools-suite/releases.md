...
[DTS v1.2.9 ISO image][ISO_DTS_v1.2.9]{ .md-button }
[sha256 ISO][ISO_DTS_sha_v1.2.9]{ .md-button }
[sha256.sig ISO][ISO_DTS_sig_v1.2.9]{ .md-button }

[USB_DTS_v1.2.9]: https://3mdeb.com/open-source-firmware/DTS/v1.2.9/dts-base-image-v1.2.9.wic.gz
[USB_DTS_sha_v1.2.9]: https://3mdeb.com/open-source-firmware/DTS/v1.2.9/dts-base-image-v1.2.9.wic.gz.sha256
[USB_DTS_sig_v1.2.9]: https://3mdeb.com/open-source-firmware/DTS/v1.2.9/dts-base-image-v1.2.9.wic.gz.sha256.sig
[ISO_DTS_v1.2.9]: https://3mdeb.com/open-source-firmware/DTS/v1.2.9/dts-base-image-v1.2.9.iso
[ISO_DTS_sha_v1.2.9]: https://3mdeb.com/open-source-firmware/DTS/v1.2.9/dts-base-image-v1.2.9.iso.sha256
[ISO_DTS_sig_v1.2.9]: https://3mdeb.com/open-source-firmware/DTS/v1.2.9/dts-base-image-v1.2.9.iso.sha256.sig
